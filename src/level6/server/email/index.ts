...
import type { Context, Handler, Middleware } from '../../../level0/types.ts'
import { createEmailApi } from '../../../level5/server/email/api.ts'
import { validateMessage, type EmailInterface, type EmailMessage, type EmailResult } from '../../../level5/server/email/contracts.ts'

/** 契约（contracts.ts 单一来源） */
export type { EmailInterface, Mailer, EmailMessage, EmailResult } from '../../../level5/server/email/contracts.ts'
export { validateMessage } from '../../../level5/server/email/contracts.ts'
export { createEmailApi, type EmailApiClient, type EmailApiOptions } from '../../../level5/server/email/api.ts'
export { MemoryEmail, createMemoryEmail, type MemoryEmailOptions } from '../../../level5/server/email/memory-email.ts'
export { MemoryEmailServer, createMemoryEmailServer, type MemoryEmailServerHandle, type MemoryEmailServerOptions } from '../../../level5/server/email/memory-email-server.ts'
