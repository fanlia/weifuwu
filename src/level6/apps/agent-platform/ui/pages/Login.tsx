...
import { setRefreshToken } from '../lib/api.ts'
import { AuthPage, Avatar, Field, Icon, Input, PasswordInput } from '../../../../client/components/index.ts'
import { inputValue } from '../lib/types.ts'
import { authErrorKey } from '../lib/i18n.ts'
