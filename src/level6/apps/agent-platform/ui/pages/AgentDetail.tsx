...
import { PageHeader, Loading } from '../../../../client/components/index.ts'
import { TypeBadge, errMsg } from '../blocks/ux.tsx'
import { Alert, Avatar, Badge, Button, Card, Checkbox, EmptyState, Field, Icon, Input, Select, Slider, Textarea, Timeline } from '../../../../client/components/index.ts'
import { inputValue } from '../lib/types.ts'
import { SkillsSection } from '../blocks/SkillsSection.tsx'
import { PreviewSection } from '../blocks/PreviewSection.tsx'
import { LogsSection } from '../blocks/LogsSection.tsx'
import { VersionsSection } from '../blocks/VersionsSection.tsx'
import { KnowledgeSection } from '../blocks/KnowledgeSection.tsx'
import type { Agent, AgentLog, Department, AvailableSkill, BoundSkill, KbChunk, KbDocument, WebhookLog } from '../lib/types.ts'
