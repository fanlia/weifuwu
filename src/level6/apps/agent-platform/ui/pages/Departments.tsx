...
import { PageHeader, EmptyState, Loading, ListScaffold } from '../../../../client/components/index.ts'
import { Ava } from '../blocks/ux.tsx'
import { Badge, Button, Card, Icon } from '../../../../client/components/index.ts'
import { isTenantOwner, clientRole, writeDenyReason } from '../lib/roles.ts'
import type { Department, DepartmentListResponse } from '../lib/types.ts'
