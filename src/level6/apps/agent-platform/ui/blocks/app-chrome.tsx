 ...
 * 业务 → 本装配器）。
 */
import type { RenderCtx, UIContext } from '../../../../client/vdom/index.ts'
import { h } from '../../../../client/vdom/index.ts'
import { AppShell, Icon, Loading } from '../../../../client/components/index.ts'
import type { AppShellNavItem } from '../../../../client/components/index.ts'
import { NAV, ADMIN_NAV } from '../lib/nav.ts'
