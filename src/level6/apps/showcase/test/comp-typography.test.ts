/**
 * showcase 组件测试——Typography（/components/typography）——完整功能
 * 每组件一个测试文件（单独运行）：node --env-file=.env --test src/level6/apps/showcase/test/comp-typography.test.ts
 */
...
const COMP_PATH = '/components/typography'
