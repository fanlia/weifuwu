/**
 * showcase 组件测试——Tabs（/components/tabs）——完整能力
 * 每组件一个测试文件（单独运行）：node --env-file=.env --test src/level6/apps/showcase/test/comp-tabs.test.ts
 */
...
const COMP_PATH = '/components/tabs'
