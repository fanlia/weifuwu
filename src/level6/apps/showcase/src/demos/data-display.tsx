...
import { h, createClientBrowser } from '../../../../client/vdom/index.ts'
import { FilePreview, FileTree, RelationGraph } from '../../../../client/components/index.ts'
...
import type { ToastItem, ToastType, ToastPosition, ToastInjected, JsonSchema } from '../../../../client/components/index.ts'
...
const DemoCodeBlock: Component = () => () => (
  <div class="wf-stack wf-gap-sm wf-width-full">
    <CodeBlock lang="ts" title="示例.ts" code={`import { Markdown } from '../../../../client/components/index.ts'
