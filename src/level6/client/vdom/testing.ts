...
import type { UIContext, Ui } from '../../../level3/vdom/context/UIContext.ts'
...
import type { Browser } from '../../../level3/vdom/browser/Browser.ts'
...
const domCache = new WeakMap<Element, { registry: ComponentRegistry; applier: CommandApplier; segments: Map<string, import('../../../level3/vdom/v2/diff.ts').Segment> }>()
