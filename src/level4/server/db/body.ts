 ...
 */
import type { ZodType, ZodRawShape } from '../../../level0/zod.ts'
import type { Shape, BodyOf, PatchOf } from '../../../level0/db/shape.ts'
...
type ShapeLike<S extends ZodRawShape> = Shape<S> | { __shape: import('../../../level0/db/shape.ts').Shape<S> }
...
export type { BodyOf, PatchOf } from '../../../level0/db/shape.ts'
