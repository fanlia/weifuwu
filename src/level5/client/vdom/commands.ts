...
import type { VNode, Component } from '../../../level0/vdom/vnode.ts'
import { renderToStreamV2 } from '../../../level3/vdom/v2/integrate.ts' // v1 退役——v2 引擎（兼容桥形态）
...
import { create, delay, tap } from '../../../level1/vdom/observable/index.ts'
