...
import { Subject, fromPromise } from '../../../../level1/vdom/observable/index.ts'
import { exhaustMap, take } from '../../../../level1/vdom/observable/index.ts'
import type { ApiClient, ApiRequestOptions } from '../../../../level1/vdom/ports.ts'

/** 端口类型单源在 core/ports.ts（W2——core 零中间件依赖）——此处重出兼容旧路径 */
export type { ApiClient, ApiRequestOptions } from '../../../../level1/vdom/ports.ts'
