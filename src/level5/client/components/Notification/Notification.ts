...
import type { UIContext, AppMiddleware } from '../../../../level6/client/vdom/index.ts'
 ...
 */
import { renderV2 } from '../../../../level3/vdom/v2/render.ts' // v1 退役——v2 引擎
import { diffV2, disposeSegment as disposeSegmentV2, type SegmentMap } from '../../../../level3/vdom/v2/diff.ts'
import { collectCommands } from '../../../../level3/vdom/v2/integrate.ts'
import { CommandApplier } from '../../../../level3/vdom/patch/index.ts'
import { createComponentRegistry } from '../../../../level3/vdom/node/component.ts'
import type { ComponentRegistry } from '../../../../level3/vdom/node/component.ts'
