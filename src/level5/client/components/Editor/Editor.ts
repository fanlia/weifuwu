...
import type { Component, VNode } from '../../../../level6/client/vdom/index.ts'
import type { UIContext } from '../../../../level6/client/vdom/index.ts'
import { createClientBrowser } from '../../../../level6/client/vdom/index.ts'
...
import type { AiStreamHandle } from '../../../../level1/vdom/hooks/ai-stream.ts'
...
export const Editor: Component<EditorProps> = (_props, ctx)=> {
  ...
  let historyHandle: import('../../../../level3/vdom/hooks/popup-manager.ts').PopupHandle | null = null
  const syncHistoryPanel = (panel: import('../../../../level6/client/vdom/index.ts').VNode): void => {
  ...
  /** 命令式句柄（唯一形态——openPopup——组件内部同步样板） */
  let linkHandle: import('../../../../level3/vdom/hooks/popup-manager.ts').PopupHandle | null = null
  const syncLinkModal = (panel: import('../../../../level6/client/vdom/index.ts').VNode | null): void => {
  ...
  let imageHandle: import('../../../../level3/vdom/hooks/popup-manager.ts').PopupHandle | null = null
  const syncImageModal = (panel: import('../../../../level6/client/vdom/index.ts').VNode | null): void => {
  ...
  let aiHandle: import('../../../../level3/vdom/hooks/popup-manager.ts').PopupHandle | null = null
  const syncAiPanel = (panel: import('../../../../level6/client/vdom/index.ts').VNode | null): void => {
