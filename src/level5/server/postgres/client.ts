...
import type { Context, Handler } from '../../../level0/types.ts'
import { HttpError } from '../../../level0/types.ts'
import { AsyncLocalStorage } from 'node:async_hooks'
import type { PostgresOptions, PostgresClient } from './types.ts'
import { compileQuery } from '../../../level0/db/query.ts'
import { compileSchemaDdl, ddlToSql, type SchemaModule } from '../../../level2/db/schema.ts'
import { diffConsistency, type ConsistencyIssue, type LiveTable } from '../../../level2/db/consistency.ts'
import { createOrm, memoryAdapter, postgresAdapter } from '../../../level2/db/orm.ts'
import { MemorySql } from '../../../level2/db/memory-sql.ts'
...
export function postgres(options?: string | PostgresOptions): PostgresClient {
  ...
  mw.migrateModule = async (name: string, mod: import('../../../level2/db/schema.ts').SchemaModule): Promise<void> => {
