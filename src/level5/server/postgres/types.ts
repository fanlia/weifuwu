import type { Context, Middleware, Closeable } from '../../../level0/types.ts'
import type { Row } from '../../../level0/db/contracts.ts'
import type { Orm, OrmTenant, CtxOrm } from '../../../level2/db/orm.ts'
...
export interface PostgresClient extends Middleware<Context, Context & PostgresInjected>, Closeable {
  ...
  migrateModule: (name: string, mod: import('../../../level2/db/schema.ts').SchemaModule) => Promise<void>
