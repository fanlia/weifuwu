...
import type { GqlShapeOptions, GqlShapeOutput } from '../../../level0/db/generator-contracts.ts'
...
export type { GqlShapeOptions, GqlShapeOutput } from '../../../level0/db/generator-contracts.ts'
