...
export function invalidDiagnostic(v) {
...
export function holeCommands(id, parent, ref, detail) {
    return [
...
export function emitHole(emit, id, parent, ref, detail) {
    for (const cmd of holeCommands(id, parent, ref, detail))
        emit(cmd);
}
