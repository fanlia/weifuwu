    ...
    mount(id, el) {
        ...
        if (typeof fn === 'function') {
            try {
                ...
                console.error('[vdom] ref mount:', e);
            }
        }
    }
            ...
            if (rid === id || rid.startsWith(id + '.')) {
                if (typeof fn === 'function') {
                    try {
                        ...
                        console.error('[vdom] ref unmount:', e);
                    }
                }
