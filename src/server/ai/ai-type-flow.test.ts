...
import { aiStream, type AiStreamCallbacks } from '../../client/ui-dom/ai.ts'
...
import type { AiChatProps } from '../../client/components/index.ts'
import { AiChat } from '../../client/components/index.ts'
