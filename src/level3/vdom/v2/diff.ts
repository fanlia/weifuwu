 ...
 *   列表移动语义下一迭代**（登记）
 */
import { noteRenderError } from '../../../level1/vdom/dev/error-counter.ts'
import type { VNode, VNodeChild } from '../../../level0/vdom/vnode.ts'
...
import { isFragment } from '../../../level1/vdom/node/fragment.ts'
import { keyOf, detectMissingKey, positionKey, isPositionKey } from '../../../level1/vdom/node/keyed.ts'
import { kindOf, textOf, isHoleKind, isTextKind } from '../../../level1/vdom/node/index.ts' // B9 单一实现源——hole/text 判定
...
import { Observable, create, Subject } from '../../../level1/vdom/observable/index.ts'
import { spyEvent } from '../../../level1/vdom/v2/spy.ts'
import { createUi } from '../hooks/env.ts'
import { normalizeOutput, outputToChild, type CompOutput } from '../node/component.ts'
import type { OperatorFn } from '../../../level1/vdom/observable/index.ts'
...
export interface Segment {
   ...
   *  平行数组 */
  destroy$: import('../../../level1/vdom/observable/index.ts').Subject<void>
  disposed: boolean
