 ...
 * 路由核心 = shared Trie（src/level0/router/trie.ts——前后端共用）——
 * 静态段优先 → :param → * 通配——params 注入 req。
 */

import type { UIContext } from './context/UIContext.ts'
import type { Command } from '../../level0/vdom/command/index.ts'
import { createTrie, trieRegister, trieMatch, splitPath, type TrieNode } from '../../level0/router/trie.ts'
import { dispatchRouter, type RouterPipeline, type RouteMatch } from '../../level0/router/pipeline.ts'
import { parseRequestTarget } from '../../level0/router/context.ts'
