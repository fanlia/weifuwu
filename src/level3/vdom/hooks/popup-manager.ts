...
import { renderV2 } from '../v2/render.ts'
import { diffV2, disposeSegment, type SegmentMap } from '../v2/diff.ts'
import { CommandApplier } from '../patch/index.ts'
import { createComponentRegistry } from '../node/component.ts'
import { PORTAL_CONTAINER_ID, portalContainerId } from '../../../level1/vdom/node/portal.ts'
import type { HookEnv } from './env.ts'
import { computePos, hasAnim, type PopupPlacement } from './popup.ts'
import { Subject, scan, type Observable } from '../../../level1/vdom/observable/index.ts'
