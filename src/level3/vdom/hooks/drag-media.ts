...
import { fromEventPattern } from '../../../level1/vdom/observable/index.ts'
...
const mediaWindowCache = new WeakMap<object, Map<string, import('../../../level1/vdom/observable/index.ts').Observable<boolean>>>()
const mediaGlobalCache = new Map<string, import('../../../level1/vdom/observable/index.ts').Observable<boolean>>() // 无 window（SSR）fallback
function getMediaSource(env: HookEnv, query: string): import('../../../level1/vdom/observable/index.ts').Observable<boolean> {
