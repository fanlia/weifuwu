...
import { createSignal } from '../../../level1/vdom/store.ts'
import { BehaviorSubject, Subject, fromPromise, shareReplay, switchMap } from '../../../level1/vdom/observable/index.ts'
...
export interface Ui {
   ...
   *  无损） */
  useObservable<T>(source: import('../../../level1/vdom/observable/index.ts').Observable<T>, init: T, opts?: { throttleMs?: number }): () => T
  ...
  signal<T>(initial: T): import('../../../level1/vdom/store.ts').Signal<T>
