...
import { create } from '../../../level1/vdom/observable/index.ts'
...
function visualViewport$(env: HookEnv): import('../../../level1/vdom/observable/index.ts').Observable<{ height: number; offsetTop: number; keyboardOpen: boolean }> {
  const win = env.getBrowser()?.window
