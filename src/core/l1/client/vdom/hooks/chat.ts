...
export interface ChatToolCall {
  ...
  approval?: import('../../../../l0/ai/types.ts').WfApprovalRequest
}
...
export interface ChatMessage {
  ...
  /** 用量（ui-dom 兼容） */
  usage?: import('../../../../l0/ai/types.ts').WfUsage
  /** HITL 审批请求（ui-dom 兼容——AiChat 读消息级 approval） */
  approval?: import('../../../../l0/ai/types.ts').WfApprovalRequest
  /** 错误（ui-dom 兼容） */
  error?: import('../../../../l0/ai/types.ts').WfError
}
...
export interface ChatChunk {
  ...
  toolCalls?: ChatToolCall[]
  /** wf:step——思考/工具状态指示 */
  step?: import('../../../../l0/ai/types.ts').WfStep | null
  /** wf:usage——token 用量 */
  usage?: import('../../../../l0/ai/types.ts').WfUsage
...
export interface ChatHandle extends ExternalStore<ChatMessage[]> {
  ...
  streaming: boolean
  /** 最近错误（ui-dom 兼容） */
  error: import('../../../../l0/ai/types.ts').WfError | null
  /** 用量（ui-dom 兼容——wf:usage） */
  usage: import('../../../../l0/ai/types.ts').WfUsage | null
