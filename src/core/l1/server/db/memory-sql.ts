...
import type { Row, QueryResult } from '../../../l0/db/contracts.ts'
import { ProtocolError } from '../../../l0/db/errors.ts'
import { HttpError } from '../../../l0/types.ts'
import type { Query, SelectQuery, WhereExpr, RawSql, ColOps } from '../../../l0/db/query.ts'
import { createQueryBuilder } from './query-builder.ts'
import { zodTypeOf } from './schema.ts'
import type { ZodType } from '../../../l0/zod.ts'
...
export class MemorySql {
  ...
  private execInsert(q: import('../../../l0/db/query.ts').InsertQuery): QueryResult<Row> {
  ...
  private execUpdate(q: import('../../../l0/db/query.ts').UpdateQuery): QueryResult<Row> {
    const t = this.table(q.table)
    const results: Row[] = []
  ...
  private execDelete(q: import('../../../l0/db/query.ts').DeleteQuery): QueryResult<Row> {
