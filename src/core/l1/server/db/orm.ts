...
import type { Query } from '../../../l0/db/query.ts'
import type { QueryResult } from '../../../l0/db/contracts.ts'
import type { ZodRawShape } from '../../../l0/zod.ts'
import { shape } from '../../../l0/db/shape.ts'
import type { GqlShapeOptions, GqlShapeOutput, RestShapeOptions, RestShapeOutput } from '../../../l0/db/generator-contracts.ts'
import type { SelectBuilder, InsertBuilder, UpdateBuilder, DeleteBuilder, QueryBuilder, WhereExpr } from '../../../l0/db/query.ts'
import type { Infer } from '../../../l0/zod.ts'
import { ValidationError } from '../../../l0/db/errors.ts'
...
export interface OrmTable<S extends ZodRawShape> {
  ...
  c: { [K in keyof S]: { ref: string; readonly __out: import('../../../l0/zod.ts').Infer<S[K]> } }
  ...
  exists(where: import('../../../l0/db/query.ts').WhereExpr): Promise<boolean>
  /** 列表模式（count+list 双查收口——平台列表面样板） */
  paginate(opts: {
    filter?: import('../../../l0/db/query.ts').WhereExpr
  ...
  readonly __shape: import('../../../l0/db/shape.ts').Shape<S>
}
...
function makeOrm(adapter: DbAdapter, tenant: OrmTenant | undefined, tables: Map<string, { t: OrmTable<ZodRawShape> }>): Orm {
  ...
  function table<S extends ZodRawShape>(name: string, shapeDef?: S): OrmTable<S> {
    ...
    const t = {
      c: c as { [K in keyof S]: { ref: string; readonly __out: import('../../../l0/zod.ts').Infer<S[K]> } },
