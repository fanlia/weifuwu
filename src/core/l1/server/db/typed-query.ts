 ...
 */
import type { ZodRawShape, ZodType } from '../../../l0/zod.ts'
import type { Orm } from './orm.ts'
import type { WhereExpr, WhereField } from '../../../l0/db/query.ts'
...
class TQB {
  private rt: import('../../../l0/db/query.ts').SelectBuilder<import('../../../l0/db/contracts.ts').Row>
  constructor(rt: import('../../../l0/db/query.ts').SelectBuilder<import('../../../l0/db/contracts.ts').Row>) { this.rt = rt }

  join(spec: string, on: WhereExpr) {
    this.rt = (this.rt.join(spec, on) as unknown as import('../../../l0/db/query.ts').SelectBuilder<import('../../../l0/db/contracts.ts').Row>)
    return this
  }
  select(...cols: (string | import('../../../l0/db/query.ts').RawSql)[]) {
    this.rt = (this.rt.select(...cols) as unknown as import('../../../l0/db/query.ts').SelectBuilder<import('../../../l0/db/contracts.ts').Row>)
    return this
  }
  where(w: WhereExpr) { this.rt = (this.rt.where(w) as unknown as import('../../../l0/db/query.ts').SelectBuilder<import('../../../l0/db/contracts.ts').Row>); return this }
  groupBy(...cols: string[]) { this.rt = (this.rt.groupBy(...cols) as unknown as import('../../../l0/db/query.ts').SelectBuilder<import('../../../l0/db/contracts.ts').Row>); return this }
  having(w: WhereExpr) { this.rt = (this.rt.having(w) as unknown as import('../../../l0/db/query.ts').SelectBuilder<import('../../../l0/db/contracts.ts').Row>); return this }
  count(col = '*', as?: string, filter?: WhereExpr) { this.rt = (this.rt.count(col, as, filter) as unknown as import('../../../l0/db/query.ts').SelectBuilder<import('../../../l0/db/contracts.ts').Row>); return this }
  sum(col: string, as?: string, filter?: WhereExpr) { this.rt = (this.rt.sum(col, as, filter) as unknown as import('../../../l0/db/query.ts').SelectBuilder<import('../../../l0/db/contracts.ts').Row>); return this }
  avg(col: string, as?: string, filter?: WhereExpr) { this.rt = (this.rt.avg(col, as, filter) as unknown as import('../../../l0/db/query.ts').SelectBuilder<import('../../../l0/db/contracts.ts').Row>); return this }
  min(col: string, as?: string, filter?: WhereExpr) { this.rt = (this.rt.min(col, as, filter) as unknown as import('../../../l0/db/query.ts').SelectBuilder<import('../../../l0/db/contracts.ts').Row>); return this }
  max(col: string, as?: string, filter?: WhereExpr) { this.rt = (this.rt.max(col, as, filter) as unknown as import('../../../l0/db/query.ts').SelectBuilder<import('../../../l0/db/contracts.ts').Row>); return this }
  vectorScore(col: string, vec: number[], as: string) { this.rt = (this.rt.vectorScore(col, vec, as) as unknown as import('../../../l0/db/query.ts').SelectBuilder<import('../../../l0/db/contracts.ts').Row>); return this }
  orderBy(col: string, dir?: 'asc' | 'desc') { this.rt = (this.rt.orderBy(col, dir) as unknown as import('../../../l0/db/query.ts').SelectBuilder<import('../../../l0/db/contracts.ts').Row>); return this }
  limit(n: number) { this.rt = (this.rt.limit(n) as unknown as import('../../../l0/db/query.ts').SelectBuilder<import('../../../l0/db/contracts.ts').Row>); return this }
  offset(n: number) { this.rt = (this.rt.offset(n) as unknown as import('../../../l0/db/query.ts').SelectBuilder<import('../../../l0/db/contracts.ts').Row>); return this }
  distinct() { this.rt = (this.rt.distinct() as unknown as import('../../../l0/db/query.ts').SelectBuilder<import('../../../l0/db/contracts.ts').Row>); return this }
  run() { return this.rt.run() as Promise<import('../../../l0/db/contracts.ts').Row[]> }
  one() { return this.rt.one() as Promise<import('../../../l0/db/contracts.ts').Row | undefined> }
}
