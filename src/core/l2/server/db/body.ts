 ...
 */
import type { ZodType, ZodRawShape } from '../../../l0/zod.ts'
import type { Shape, BodyOf, PatchOf } from '../../../l0/db/shape.ts'
...
type ShapeLike<S extends ZodRawShape> = Shape<S> | { __shape: import('../../../l0/db/shape.ts').Shape<S> }
...
export type { BodyOf, PatchOf } from '../../../l0/db/shape.ts'
