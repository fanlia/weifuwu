...
describe('Field', () => {
  it('renders children', () => {
    const vnode = renderVNode(Field, { children: '字段内容' }, createTestCtx())!
  ...
  it('renders label when provided', () => {
    const vnode = renderVNode(Field, { label: '名称', children: '内容' }, createTestCtx())!
  ...
  it('shows required marker', () => {
    const vnode = renderVNode(Field, { label: '名称', required: true, children: '内容' }, createTestCtx())!
  ...
  it('shows error message', () => {
    const vnode = renderVNode(Field, { error: '必填', children: '内容' }, createTestCtx())!
  ...
  it('shows hint text', () => {
    const vnode = renderVNode(Field, { hint: '提示文字', children: '内容' }, createTestCtx())!
