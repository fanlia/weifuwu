...
import { ErrorBoundary } from '../../../src/react/error-boundary.ts'
  ...
  return (
    <div className="rounded-lg border border-gray-200 p-6 text-center">
      ...
      <button
        ...
        className="mt-3 px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 cursor-pointer"
      >
        +
      </button>
    </div>
  ...
  return (
    <div>
      ...
      <p className="text-gray-600 mb-6">
        The counter below will throw on the 4th click. ErrorBoundary catches the error
        and shows fallback UI instead of crashing the whole page.
      </p>
      ...
      <div className="rounded-lg border border-green-200 bg-green-50 p-6 mt-4">
        <p className="text-green-700">
          ✅ This section is unaffected — ErrorBoundary isolates the error.
        </p>
      </div>
    </div>
  )
