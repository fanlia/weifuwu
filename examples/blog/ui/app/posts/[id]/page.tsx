  ...
  if (!post) {
    return (
      <div className="max-w-3xl mx-auto px-4 py-20 text-center">
        ...
        <a href="/" className="text-blue-600 dark:text-blue-400 hover:underline">{t('post.back')}</a>
      </div>
    )
  }
  ...
  return (
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        <a href="/" className="text-sm text-blue-600 dark:text-blue-400 hover:underline mb-6 inline-block">
          {t('post.back')}
        </a>
