...
> props 提取降级（接口格式特殊）——见源码：`src/client/components/Editor/Editor.ts`
...
| 文件 | 路径 |
|------|------|
| 源码 | `src/client/components/Editor/Editor.ts` |
| 样式 | `src/client/components/Editor/Editor.css` |
| 测试 | `src/client/components/Editor/Editor.test.ts` |
