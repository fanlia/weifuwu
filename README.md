...
| `weifuwu/components` | `https://unpkg.com/weifuwu@latest/dist/components/style.css` | 组件 CSS + 154 个主题 Token + 70 个布局原语 |
...
| `weifuwu/layout` | **CSS 布局** | 70 个布局原语 + 154 个主题 Token（也支持 `weifuwu/layout/style.css`） | — |
...
| [docs/layout.md](docs/layout.md) | 布局系统：70 个布局原语 + 154 个主题 Token |
