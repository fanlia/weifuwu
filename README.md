...
| 样式 | `weifuwu/layout` | 57 布局原语 + 136 工具类 + 166 主题 Token，零自定义 CSS 文件 |
...
| `weifuwu/components` | `https://unpkg.com/weifuwu@latest/dist/components/style.css` | 组件 CSS + 166 个主题 Token + 57 个布局原语 + 136 个工具类 |
...
| `weifuwu/layout` | **CSS 布局** | 57 个布局原语 + 136 个工具类 + 166 个主题 Token（也支持 `weifuwu/layout/style.css`） | — |
...
| 布局/主题/暗色 | `weifuwu/layout`（57 原语 + 136 工具类 + 166 Token） | [docs/layout.md](docs/layout.md) |
...
| [docs/layout.md](docs/layout.md) | 布局系统：57 个布局原语 + 136 个工具类 + 166 个主题 Token |
