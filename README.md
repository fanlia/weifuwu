...
| 组件样式 | `https://unpkg.com/weifuwu@latest/dist/components/style.css` | 组件 CSS + 89 个主题 Token + 35 个布局原语 |
...
| `weifuwu/layout` | **CSS 布局** | 35 个布局原语 + 89 个主题 Token（也支持 `weifuwu/layout/style.css`） | — |
...
纯 CSS 布局原语 + 89 个主题 Token。不绑定任何 JS 框架。
