...
export default function DashboardOverview(_props: {}, ctx: WfuiContext) {
  const stats = [
  ...
  return () => (
    <div>
      ...
      <div class="grid grid-cols-2 gap-4 mb-6">
        {stats.map((s: any) => (
          <div key={s.label} class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-100 divide-y divide-gray-100">
        {activities.map((a: any) => (
          <div key={a.id} class="flex items-center justify-between px-4 py-3">
