...
export const MultiEmbed: Component = async (_init: any, _ctx: any) => {
  ...
  return async (_p: any) => (
    <div class="wf-stack wf-gap-sm">
      <div class="wf-font-xs wf-text-secondary">← 活体运行（父应用嵌子应用——计数器 + 迷你任务独立状态）</div>
      <div class="wf-surface wf-surface--flat wf-border wf-radius-md wf-padding-md" style="min-height:300px" ref={embedRef} />
