...
function AppShell(_props, ctx2) {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx(Show, { when: isLoggedIn, fallback: /* @__PURE__ */ jsx(LoginPage, { _props: {}, ctx: ctx2 }), children: /* @__PURE__ */ jsx(Show, { when: isChat, fallback: /* @__PURE__ */ jsx(BrowseLayout, { _props: {}, ctx: ctx2 }), children: /* @__PURE__ */ jsx(ChatLayout, { _props: {}, ctx: ctx2 }) }) })
  ] });
}
var routes = [
