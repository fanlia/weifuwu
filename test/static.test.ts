...
describe('serveStatic', () => {
  it('serves a file', async () => {
    ...
    const res = await r.handler()(new Request('http://localhost/files/hello.txt'), {
      params: {},
      query: {},
    } as any)
  ...
  it('sets Content-Type based on extension', async () => {
    const r = new Router().get('/files/*', serveStatic(tmpDir))
    const res = await r.handler()(new Request('http://localhost/files/script.js'), {
      params: {},
      query: {},
    } as any)
  ...
  it('returns 304 on matching ETag', async () => {
    const r = new Router().get('/files/*', serveStatic(tmpDir))
    const res1 = await r.handler()(new Request('http://localhost/files/hello.txt'), {
      params: {},
      query: {},
    } as any)
  ...
  it('serves index.html for directory', async () => {
    const r = new Router().get('/files/*', serveStatic(tmpDir))
    const res = await r.handler()(new Request('http://localhost/files/'), {
      params: {},
      query: {},
    } as any)
    assert.equal(res.status, 200)
  ...
  it('returns 404 for missing file', async () => {
    const r = new Router().get('/files/*', serveStatic(tmpDir))
    const res = await r.handler()(new Request('http://localhost/files/nope.txt'), {
      params: {},
      query: {},
    } as any)
  ...
  it('blocks directory traversal via wildcard param', async () => {
    ...
    const res = await handler(new Request('http://localhost/ignored'), {
      params: { '*': '../../package.json' },
      query: {},
    } as any)
  ...
  it('supports nested paths', async () => {
    const r = new Router().get('/files/*', serveStatic(tmpDir))
    const res = await r.handler()(new Request('http://localhost/files/sub/deep.txt'), {
      params: {},
      query: {},
    } as any)
    assert.equal(res.status, 200)
  ...
  it('follows symlinks within root directory', async () => {
    const r = new Router().get('/files/*', serveStatic(tmpDir))
    const res = await r.handler()(new Request('http://localhost/files/link.txt'), {
      params: {},
      query: {},
    } as any)
    assert.equal(res.status, 200)
  ...
  it('serves directory index with correct ETag from index file', async () => {
    ...
    const etag2 = (
      await r.handler()(new Request('http://localhost/files/'), { params: {}, query: {} } as any)
    ).headers.get('ETag')
  ...
  it('blocks null byte in path', async () => {
    const r = new Router().get('/files/*', serveStatic(tmpDir))
    const res = await r.handler()(new Request('http://localhost/files/%00x.txt'), {
      params: {},
      query: {},
    } as any)
    assert.equal(res.status, 403)
  ...
  it('blocks symlink escaping root directory', async () => {
    const r = new Router().get('/files/*', serveStatic(tmpDir))
    const res = await r.handler()(new Request('http://localhost/files/escape.txt'), {
      params: {},
      query: {},
    } as any)
    assert.equal(res.status, 403)
  ...
  it('returns 404 when directory index target is not a file', async () => {
    const r = new Router().get('/files/*', serveStatic(tmpDir))
    const res = await r.handler()(new Request('http://localhost/files/not-a-file/'), {
      params: {},
      query: {},
    } as any)
    assert.equal(res.status, 404)
  ...
  it('falls back to application/octet-stream for unknown extension', async () => {
    const r = new Router().get('/files/*', serveStatic(tmpDir))
    const res = await r.handler()(new Request('http://localhost/files/data.bin'), {
      params: {},
      query: {},
    } as any)
    assert.equal(res.status, 200)
  ...
  it('returns 500 for unreadable file', async () => {
    const r = new Router().get('/files/*', serveStatic(tmpDir))
    const res = await r.handler()(new Request('http://localhost/files/no-perm.txt'), {
      params: {},
      query: {},
    } as any)
