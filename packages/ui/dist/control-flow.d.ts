 ...
 * ```
 */
export declare function when(signal: Signal<unknown> | Computed<unknown>, factory: () => VNode | null | undefined): ShowNode;
/**
 ...
 * ```
 */
export declare function each(signal: Signal<unknown[]> | Computed<unknown[]>, factory: (item: unknown, index: number) => VNode): EachNode;
